...
namespace ReferenceTypes
{
    ...
    public class UnitTest1
    {
        ...
        public void Strings()
        {
            ...
            string declaredAndInitialize = "This is both declaring and initializing";

            string firstName = "Jon";
            string lastName = "Hendrick";

            string concatenanatedFullName = firstName + " " + lastName;
            ...
            Console.WriteLine(concatenanatedFullName);
